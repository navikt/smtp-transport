 ...
 * And default value can also contain an other reference (with it own default):
 * ${{ ref:path :- http://localhost:${{ ref:port :- 9080 }} }}.
 */
object FixedReferenceContextResolver : FixedContextResolver() {
