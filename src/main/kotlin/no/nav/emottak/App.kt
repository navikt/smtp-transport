    ...
    result {
        resourceScope {
            ...
            try {
                ...
                (deps.migrationService.configuration.dataSource as? HikariDataSource)?.also {
                    it.close()
                    log.info("Flyway migration datasource closed")
                } ?: log.warn("Failed to close flyway migration datasource")
            }
