...
class SmtpTransportIntegrationTest : StringSpec(
    {
        ...
        "Hent payload - ingen treff" {
            smtpTransportTestApp(payloadRepository) {
                ...
                payloadNotFound.referenceId shouldBe "f7aeef95-afca-4355-b6f7-1692e58c61cc"
            }
        }
        ...
        "Hent payload - ugyldig id" {
            smtpTransportTestApp(payloadRepository) {
                ...
                httpResponse.bodyAsText() shouldBe "ReferenceId is not a valid UUID: 'ugyldig-reference-id'."
            }
        }
    }
)
